<template>
    ...
    <div class="main">
        <div class="header py-10 px-20 bg-[#E7FEEA]">
            <h3 class="txtHeader font-bold text-2xl">Kalender</h3>
            <p class="my-1 text-justify">
                Halaman ini berisi jadwal kegiatan yang diselenggarakan oleh SHAR3.
            </p>
        </div>
        <div class="content flex mx-12">
            ...
            <div class="article inline-block my-12 mx-12 bg-[#E7FEEA] rounded-2xl py-7 px-10 w-full">
                <h4 class="font-semibold text-xl">Kalender SHAR3</h4>
