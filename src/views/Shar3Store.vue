<template>
    ...
    <div class="main">
        <div class="header py-10 px-20 bg-[#E7FEEA]">
            <h3 class="txtHeader font-bold text-2xl">SHAR3 Store</h3>
            <p class="my-1 text-justify">
                SHAR3 Store adalah toko online yang dikelola oleh anggota SHAR3, toko ini menjual berbagai produk dari berbagai alumni Rohis SMAN 3 Kabupaten Tangerang.
            </p>
        </div>
        <div class="content flex mx-12">
            ...
            <div class="article inline-block my-12 mx-12 bg-[#E7FEEA] rounded-2xl py-7 px-10 w-full">
                <h4 class="font-semibold text-xl">SHAR3 Store</h4>
